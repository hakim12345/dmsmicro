...
public class EmailConfig {
    ...
    @Bean
    public com.dms.recieveClient.email.HtmlEmailSender HtmlEmailSender() {
        com.dms.recieveClient.email.HtmlEmailSenderImpl htmlEmailSenderImpl = new com.dms.recieveClient.email.HtmlEmailSenderImpl();
